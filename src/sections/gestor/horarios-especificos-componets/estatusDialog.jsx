...
export default function ModalEstatus({ open, onClose, id, estatus }) {
  ...
  const updateEstatus = useUpdate(endpoints.gestor.updateEstatusHorario);
  ...
  return (
    <>
      <Stack spacing={1} >
        {estatus === 1 ?
            <DialogTitle>¿Estás seguro que quieres deshabilitar el horario?</DialogTitle>
            : <DialogTitle>¿Estás seguro que quieres habilitar el horario?</DialogTitle>
        }
      </Stack>
