              ...
              <Stack spacing={1} key={item.pregunta}>
                ...
                {item.respuestas === '1' && (
                  <Typography variant="subtitle2">
                    {' '}
                    Respuestas: {Resp1Data.map((i) => i.label).join(', ')}{' '}
                  </Typography>
                )}
                ...
                {item.respuestas === '2' && (
                  <Typography variant="subtitle2">
                    {' '}
                    Respuestas: {Resp2Data.map((i) => i.label).join(', ')}{' '}
                  </Typography>
                )}
                ...
                {item.respuestas === '3' && (
                  <Typography variant="subtitle2">
                    {' '}
                    Respuestas: {Resp3Data.map((i) => i.label).join(', ')}{' '}
                  </Typography>
                )}
                ...
                {item.respuestas === '4' && (
                  <Typography variant="subtitle2">
                    {' '}
                    Respuestas: {Resp4Data.map((i) => i.label).join(', ')}{' '}
                  </Typography>
                )}
