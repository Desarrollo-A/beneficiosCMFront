...
export default function ModalPoliticas({ open, onClose }) {
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
      PaperProps={{
        sx: { maxWidth: 720, scrollbarWidth: 'thin', scrollbarColor: '#003764 #B4A46C' },
      }}
    >
      ...
      <Stack spacing={1} sx={{ textAlign: 'justify', margin: '40px' }}>
        ...
        <DialogContent style={{ fontWeight: 'bold', color: '#003764' }} variant="h7">OBJETIVO GENERAL </DialogContent>
